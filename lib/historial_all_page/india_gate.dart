          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("India Gate",style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold),),
                  Row(
                    children: [
                      Rating.rating[0],
                      Rating.rating[0],
            ...
            Padding(
              ...
              child: ConstrainedBox(
                constraints: BoxConstraints(maxHeight: double.infinity),
                child: Text("India Gate is one of the best historical places to "
                    "visit in Delhi. It is an arch-shaped structure that stands at a "
                    "height of 42 metres and is placed in the middle of a majestic lawn. "
                    "It serves as a symbol of India’s spirit, unity, and resilience."
                    "\nConstructed in 1931, India Gate was built in honour of the soldiers "
                    "who sacrificed their lives during World War I and the Indo-Afghan War."
                    " The names of more than 13,000 brave souls are written on the walls "
                    "of the monument. The inscription serves as a reminder of their bravery"
                    " and valour.\nThe architecture of the India Gate draws inspiration"
                    " from the Arc De Triomphe in Paris. Made of red sandstone, the "
                    "monument includes detailed designs, and the area is perfect for "
                    "tourists and locals to take a walk. \nThe monument and the surrounding "
                    "area light up at night and present a mesmerising sight. You can also"
                    " take a walk in the area, enjoying street foods from the food stalls.",
